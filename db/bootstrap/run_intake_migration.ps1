...
$sqlPath = Join-Path $PSScriptRoot 'apply_intake_migration.sql'
$resultPath = Join-Path $env:LOCALAPPDATA 'Temp\perfect_catalog_0007.exit'
...
Write-Host 'Aplicando migracion 0007 en perfect_catalog_dev.'
