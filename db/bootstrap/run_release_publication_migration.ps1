...
$sqlPath = Join-Path $PSScriptRoot 'apply_release_publication_migration.sql'
$resultPath = Join-Path $env:LOCALAPPDATA 'Temp\perfect_catalog_0005.exit'
...
Write-Host 'Aplicando migracion 0005 en perfect_catalog_dev.'
